 ...
 *
 * Despite its name, notification-retry-helper does NOT process PENDING
 ...
 *   → notification-batch-processor     [canonical batch processor — inserts email_queue rows]
 *   → email_queue (Pending)
 ...
 * For batch processing, see: supabase/functions/notification-batch-processor/index.ts
 */
