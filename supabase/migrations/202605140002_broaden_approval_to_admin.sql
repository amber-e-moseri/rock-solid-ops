...
-- Broaden approval authorization for approve_teacher_availability_atomic.
-- Fixes admin-role approval failures by allowing both admin and superadmin.
-- Function body is otherwise kept aligned with the canonical 202605130900 version.
